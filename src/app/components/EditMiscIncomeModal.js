...
import { updateMiscIncome } from '@/app/actions/income'
import { useState } from 'react'

export default function EditMiscIncomeModal({ isOpen, onClose, income, accounts }) {
  ...
  async function handleSubmit(e) {
    ...
    const result = await updateMiscIncome(income.id, formData)
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">Edit Misc Income</h2>
