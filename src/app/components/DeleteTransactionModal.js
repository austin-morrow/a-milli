          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Are you sure you want to delete the transaction <span className="font-semibold">"{transaction.description}"</span>? This will also reverse its effect on your account balance. This action cannot be undone.
              </p>
            </div>
          </div>
